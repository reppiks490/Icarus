...
def main(argv: Optional[list] = None) -> int:
    ...
    def add_subcommand_root(parser: argparse.ArgumentParser) -> None:
        # Keep the documented "command --root DIR" form while preserving
        # the existing global "--root DIR command" form. SUPPRESS prevents a
        # subparser default from overwriting a root parsed by the parent.
        parser.add_argument(
            "--root",
